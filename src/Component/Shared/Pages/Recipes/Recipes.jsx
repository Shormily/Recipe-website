        ...
        <div className="flex max-w-[1400px] m-auto   items-center justify-center ">
          ...
          <div className="pt-3  flex">
                ...
                <p className="text-justify  pt-5 font-medium px-3 ft-text hover:text-[#7f1d1d] cursor-pointer">
                  <p className="text-[20px]">Stuffed Hamburger</p> <br />
                  Lecture: Towards <br /> a silent aircraft
                  <br />
                <p className='pt-4'>From <span className='font-2xl pt-2'>$250</span></p>  
                </p>
              </div>
              <div className="pt-3  flex">
                <div className=" pt-3 ">
              ...
              <div className="pt-3  flex">
               ...
               <div className="pt-3  flex">
                ...
                <p className="text-justify  pt-5 font-medium px-3 ft-text hover:text-[#7f1d1d] cursor-pointer">
                  ...
                  Lecture: Towards <br /> a silent aircraft
                  <br />
                <p className='pt-4'>From <span className='text-2xl font-bold text-[#a87434fd] pt-2'>$250</span></p>  
                </p>
              </div>
            </div>
